...
<div class="select is-primary">
  <select name="limits" id="limits" class="mx-2">
...
<div class="mx-3">
  <h1 class="has-text-black">Lista de Pokemons</h1>
  <ul id="lista-pokemons" />
</div>

<div>
  <button id="btn-anterior" class="button is-light">Anterior</button>
  <button id="btn-proximo" class="button is-dark">Próximo</button>
  <p id="paginas" />
</div>

<section class="section">
  <div id="pokemon-selecionado" class="my-2">
    <p id="nome-pokemon-selecionado" class="my-2" />
    <img alt="" id="imagem-pokemon-selecionado" />
    <p id="atributos-pokemon-selecionado" class="my-2" />
    <p id="caracteristicas-pokemon-selecionado" class="my-2" />
    <p id="altura-peso-pokemon-selecionado" class="my-2" />
  </div>
</section>
